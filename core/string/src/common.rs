...
const RAW_STATICS: &[JsStr<'static>] = &[
    ...
    JsStr::latin1("ReadableStream".as_bytes()),
    JsStr::latin1("WritableStream".as_bytes()),
    JsStr::latin1("TransformStream".as_bytes()),
    JsStr::latin1("CountQueuingStrategy".as_bytes()),
    JsStr::latin1("ByteLengthQueuingStrategy".as_bytes()),
    ...
    JsStr::latin1("RTCSessionDescription".as_bytes()),
    // WebAssembly API
    ...
    JsStr::latin1("ServiceWorker".as_bytes()),
    JsStr::latin1("ServiceWorkerContainer".as_bytes()),
    JsStr::latin1("Worklet".as_bytes()),
    JsStr::latin1("MessageChannel".as_bytes()),
    JsStr::latin1("MessagePort".as_bytes()),
    JsStr::latin1("MessageEvent".as_bytes()),
    JsStr::latin1("BroadcastChannel".as_bytes()),
    JsStr::latin1("Crypto".as_bytes()),
    JsStr::latin1("AbortController".as_bytes()),
    JsStr::latin1("TextEncoder".as_bytes()),
    JsStr::latin1("TextDecoder".as_bytes()),
    JsStr::latin1("URL".as_bytes()),
    JsStr::latin1("URLSearchParams".as_bytes()),
    JsStr::latin1("Document".as_bytes()),
    JsStr::latin1("Window".as_bytes()),
    JsStr::latin1("History".as_bytes()),
    JsStr::latin1("Location".as_bytes()),
    JsStr::latin1("PageSwapEvent".as_bytes()),
    JsStr::latin1("Node".as_bytes()),
    JsStr::latin1("CharacterData".as_bytes()),
    JsStr::latin1("Text".as_bytes()),
    JsStr::latin1("DocumentFragment".as_bytes()),
    JsStr::latin1("ShadowRoot".as_bytes()),
    JsStr::latin1("NodeList".as_bytes()),
    JsStr::latin1("Element".as_bytes()),
    JsStr::latin1("HTMLElement".as_bytes()),
    JsStr::latin1("HTMLScriptElement".as_bytes()),
    JsStr::latin1("HTMLIFrameElement".as_bytes()),
    JsStr::latin1("DOMParser".as_bytes()),
    JsStr::latin1("FormData".as_bytes()),
    JsStr::latin1("CSSStyleDeclaration".as_bytes()),
    JsStr::latin1("HTMLFormElement".as_bytes()),
    JsStr::latin1("HTMLFormControlsCollection".as_bytes()),
    JsStr::latin1("HTMLInputElement".as_bytes()),
    JsStr::latin1("HTMLSlotElement".as_bytes()),
    JsStr::latin1("HTMLImageElement".as_bytes()),
    JsStr::latin1("ImageBitmap".as_bytes()),
    JsStr::latin1("Path2D".as_bytes()),
    JsStr::latin1("HTMLCanvasElement".as_bytes()),
    JsStr::latin1("CanvasRenderingContext2D".as_bytes()),
    JsStr::latin1("OffscreenCanvas".as_bytes()),
    JsStr::latin1("HTMLAudioElement".as_bytes()),
    JsStr::latin1("AudioContext".as_bytes()),
    JsStr::latin1("HTMLVideoElement".as_bytes()),
    JsStr::latin1("Selection".as_bytes()),
    JsStr::latin1("Range".as_bytes()),
    JsStr::latin1("Event".as_bytes()),
    JsStr::latin1("EventTarget".as_bytes()),
    JsStr::latin1("UIEvent".as_bytes()),
    JsStr::latin1("KeyboardEvent".as_bytes()),
    JsStr::latin1("MouseEvent".as_bytes()),
    JsStr::latin1("FocusEvent".as_bytes()),
    JsStr::latin1("InputEvent".as_bytes()),
    JsStr::latin1("CustomEvent".as_bytes()),
    JsStr::latin1("ErrorEvent".as_bytes()),
    JsStr::latin1("ProgressEvent".as_bytes()),
    JsStr::latin1("HashChangeEvent".as_bytes()),
    JsStr::latin1("PopStateEvent".as_bytes()),
    JsStr::latin1("CloseEvent".as_bytes()),
    JsStr::latin1("AbortSignal".as_bytes()),
