...
impl StaticJsStrings {
    ...
    well_known_statics! {
        ...
        // Web APIs - Thalora Browser Extensions
        ...
        (HTML_DIALOG_ELEMENT, "HTMLDialogElement"),
        (HTML_DETAILS_ELEMENT, "HTMLDetailsElement"),
        ...
        (FORM_CONTROLS_COLLECTION, "HTMLFormControlsCollection"),
        ...
        (HTML_AUDIO_ELEMENT, "HTMLAudioElement"),
...
const RAW_STATICS: &[StaticString] = &[
    ...
    StaticString::new(JsStr::latin1("$".as_bytes())),
    // Web APIs - Thalora Browser Extensions
    StaticString::new(JsStr::latin1("ReadableStream".as_bytes())),
    StaticString::new(JsStr::latin1("WritableStream".as_bytes())),
    StaticString::new(JsStr::latin1("TransformStream".as_bytes())),
    StaticString::new(JsStr::latin1("CountQueuingStrategy".as_bytes())),
    StaticString::new(JsStr::latin1("ByteLengthQueuingStrategy".as_bytes())),
    StaticString::new(JsStr::latin1("WebSocket".as_bytes())),
    StaticString::new(JsStr::latin1("WebSocketStream".as_bytes())),
    StaticString::new(JsStr::latin1("EventSource".as_bytes())),
    StaticString::new(JsStr::latin1("RTCPeerConnection".as_bytes())),
    StaticString::new(JsStr::latin1("RTCDataChannel".as_bytes())),
    StaticString::new(JsStr::latin1("RTCIceCandidate".as_bytes())),
    StaticString::new(JsStr::latin1("RTCSessionDescription".as_bytes())),
    StaticString::new(JsStr::latin1("Worker".as_bytes())),
    StaticString::new(JsStr::latin1("WorkerNavigator".as_bytes())),
    StaticString::new(JsStr::latin1("SharedWorker".as_bytes())),
    StaticString::new(JsStr::latin1("ServiceWorker".as_bytes())),
    StaticString::new(JsStr::latin1("ServiceWorkerContainer".as_bytes())),
    StaticString::new(JsStr::latin1("Worklet".as_bytes())),
    StaticString::new(JsStr::latin1("MessageChannel".as_bytes())),
    StaticString::new(JsStr::latin1("MessagePort".as_bytes())),
    StaticString::new(JsStr::latin1("MessageEvent".as_bytes())),
    StaticString::new(JsStr::latin1("BroadcastChannel".as_bytes())),
    StaticString::new(JsStr::latin1("Crypto".as_bytes())),
    StaticString::new(JsStr::latin1("AbortController".as_bytes())),
    StaticString::new(JsStr::latin1("TextEncoder".as_bytes())),
    StaticString::new(JsStr::latin1("TextDecoder".as_bytes())),
    StaticString::new(JsStr::latin1("URL".as_bytes())),
    StaticString::new(JsStr::latin1("URLSearchParams".as_bytes())),
    StaticString::new(JsStr::latin1("Document".as_bytes())),
    StaticString::new(JsStr::latin1("Window".as_bytes())),
    StaticString::new(JsStr::latin1("History".as_bytes())),
    StaticString::new(JsStr::latin1("Location".as_bytes())),
    StaticString::new(JsStr::latin1("PageSwapEvent".as_bytes())),
    StaticString::new(JsStr::latin1("Node".as_bytes())),
    StaticString::new(JsStr::latin1("CharacterData".as_bytes())),
    StaticString::new(JsStr::latin1("Text".as_bytes())),
    StaticString::new(JsStr::latin1("Comment".as_bytes())),
    StaticString::new(JsStr::latin1("DocumentFragment".as_bytes())),
    StaticString::new(JsStr::latin1("ShadowRoot".as_bytes())),
    StaticString::new(JsStr::latin1("NodeList".as_bytes())),
    StaticString::new(JsStr::latin1("Element".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLScriptElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLDialogElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLDetailsElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLIFrameElement".as_bytes())),
    StaticString::new(JsStr::latin1("DOMParser".as_bytes())),
    StaticString::new(JsStr::latin1("FormData".as_bytes())),
    StaticString::new(JsStr::latin1("CSSStyleDeclaration".as_bytes())),
    StaticString::new(JsStr::latin1("CSS".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLFormElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLFormControlsCollection".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLInputElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLSlotElement".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLImageElement".as_bytes())),
    StaticString::new(JsStr::latin1("ImageBitmap".as_bytes())),
    StaticString::new(JsStr::latin1("Path2D".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLCanvasElement".as_bytes())),
    StaticString::new(JsStr::latin1("CanvasRenderingContext2D".as_bytes())),
    StaticString::new(JsStr::latin1("OffscreenCanvas".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLAudioElement".as_bytes())),
    StaticString::new(JsStr::latin1("AudioContext".as_bytes())),
    StaticString::new(JsStr::latin1("HTMLVideoElement".as_bytes())),
    StaticString::new(JsStr::latin1("Selection".as_bytes())),
    StaticString::new(JsStr::latin1("Range".as_bytes())),
    StaticString::new(JsStr::latin1("Event".as_bytes())),
    StaticString::new(JsStr::latin1("EventTarget".as_bytes())),
    StaticString::new(JsStr::latin1("UIEvent".as_bytes())),
    StaticString::new(JsStr::latin1("KeyboardEvent".as_bytes())),
    StaticString::new(JsStr::latin1("MouseEvent".as_bytes())),
    StaticString::new(JsStr::latin1("FocusEvent".as_bytes())),
    StaticString::new(JsStr::latin1("InputEvent".as_bytes())),
    StaticString::new(JsStr::latin1("CustomEvent".as_bytes())),
    StaticString::new(JsStr::latin1("ErrorEvent".as_bytes())),
    StaticString::new(JsStr::latin1("ProgressEvent".as_bytes())),
    ...
    StaticString::new(JsStr::latin1("FetchEvent".as_bytes())),
